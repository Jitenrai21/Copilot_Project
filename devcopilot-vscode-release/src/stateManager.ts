...
export class StateManager {
    ...
    getRepoPath(): string | undefined {
        return this.context.workspaceState.get<string>('devcopilotV3.repoPath');
    }
    ...
    getDbPath(): string | undefined {
        return this.context.workspaceState.get<string>('devcopilotV3.dbPath');
    }
    ...
    getCollectionName(): string | undefined {
        return this.context.workspaceState.get<string>('devcopilotV3.collectionName');
    }
