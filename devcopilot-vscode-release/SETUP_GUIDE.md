...
**🔒 Recommended Method: Secure Storage**
1. Install and activate the extension
2. Open Command Palette (Ctrl+Shift+P)
3. Run: **DevCopilot: Set API Key**
4. Enter your API key (stored securely in VS Code SecretStorage)
5. Verify with: **DevCopilot v2: Show Pipeline Status**

**Alternative Methods:**

#### Option A: Environment Variables (For CI/CD or automation)
```bash
# Windows PowerShell
...
```
Then restart VS Code to apply.

#### Option B: VS Code Settings (Not Recommended - Less Secure)
1. Open VS Code Settings (Ctrl+,)
2. Search for "DevCopilot"
3. Set `devcopilotV2.apiKey` (this will be stored in plain text)

**Security Priority Order:**
1. ✅ SecretStorage (most secure, per-user encrypted)
2. ✅ Environment variable (good for automation)
3. ⚠️ VS Code settings (fallback, not recommended)
