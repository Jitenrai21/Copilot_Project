...
2. Type: **DevCopilot: Set API Key**
3. Enter your LLM API key (Groq, OpenAI, etc.)
4. The key is stored securely in VS Code's encrypted storage

**Alternative:** Set the `LLM_API_KEY` environment variable and restart VS Code.
