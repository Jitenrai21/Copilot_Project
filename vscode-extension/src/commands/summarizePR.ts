...
export async function summarizePRCommand(resultsProvider: ResultsViewProvider, stateManager: StateManager, providedRepoPath?: string, providedTimeout?: number) {
    ...
    await vscode.window.withProgress({
        ...
        try {
            const summary = await summarizePR(stateManager, repoPath, timeout);
