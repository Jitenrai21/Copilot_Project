...
export class StateManager {
    ...
    getRepoPath(): string | undefined {
        return this.context.workspaceState.get<string>('devcopilot.repoPath');
    }
    ...
    getDbPath(): string | undefined {
        return this.context.workspaceState.get<string>('devcopilot.dbPath');
    }
    ...
    getCollectionName(): string | undefined {
        return this.context.workspaceState.get<string>('devcopilot.collectionName');
    }
    ...
    async setPipelineConfig(repoPath: string, dbPath: string, collectionName: string): Promise<void> {
        await this.context.workspaceState.update('devcopilot.repoPath', repoPath);
        await this.context.workspaceState.update('devcopilot.dbPath', dbPath);
        await this.context.workspaceState.update('devcopilot.collectionName', collectionName);
    }
    ...
    async clearPipelineConfig(): Promise<void> {
        await this.context.workspaceState.update('devcopilot.repoPath', undefined);
        await this.context.workspaceState.update('devcopilot.dbPath', undefined);
        await this.context.workspaceState.update('devcopilot.collectionName', undefined);
    }
