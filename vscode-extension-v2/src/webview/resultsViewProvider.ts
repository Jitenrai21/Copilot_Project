...
export class ResultsViewProvider implements vscode.WebviewViewProvider {
    public static readonly viewType = 'devcopilotV2.resultsView';
    ...
    public resolveWebviewView(
        ...
        console.log('DevCopilot v2: resolveWebviewView called - view is being initialized');
    ...
    private async _retrySummarization(repoPath: string, timeout: number) {
        ...
        await vscode.window.withProgress({
            ...
            try {
                ...
                await vscode.commands.executeCommand('devcopilotV2.summarizePR', repoPath, timeout);
            } catch (error) {
